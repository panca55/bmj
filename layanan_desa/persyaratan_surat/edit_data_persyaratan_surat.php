...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $uploadFile)) {
            ...
            $stmt = $conn->prepare("UPDATE tb_persyaratan_surat SET keterangan = ?, file = ? WHERE id_persyaratan_surat = ?");
...
<div class="container mt-5">
    <h2>Edit Data Persyaratan Surat</h2>
    <form method="post" class="mt-4" enctype="multipart/form-data">
        ...
        <a href="/admin_dashboard.php?page=layanan_desa/layanan_desa&subpage=persyaratan_surat" class="btn btn-secondary ms-3">Batal</a>
    </form>
</div>