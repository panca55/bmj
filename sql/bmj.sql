...
--
-- Host: localhost:3306
-- Waktu pembuatan: 17 Mar 2025 pada 14.28
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
CREATE TABLE `tb_kepala_desa` (
  ...
  `foto` varchar(255) DEFAULT NULL,
  `keterangan_jabatan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE `tb_layanan` (
  ...
  `layanan_desa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tb_profil_desa` (
  ...
  `sejarah_desa` text,
  `visi_desa` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `misi_desa` text,
  `struktur_desa` blob,
