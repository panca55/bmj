...
<div class="d-flex flex-column">
    <div class="d-flex flex-column text-center">
        ...
        <div class="d-flex flex-row justify-content-end my-2">
            <a href="/admin_dashboard.php?page=profile_desa/profil_desa&subpage=monografi_kependudukan/tambah_data_monografi_kependudukan"
    ...
    <div class="d-flex flex-row justify-content-end">
        <a href="/admin_dashboard.php?page=profile_desa/profil_desa&subpage=monografi_kependudukan/edit_data_monografi_kependudukan"
...
<script>
    document.getElementById('tambah-data-link').addEventListener('click', function(event) {
        ...
        // Update the URL
        window.history.pushState({}, '', 'admin_dashboard.php?page=profile_desa/profil_desa&subpage=monografi_kependudukan/tambah_data_monografi_kependudukan');
