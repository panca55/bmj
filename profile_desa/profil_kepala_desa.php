...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete'])) {
    ...
    if ($stmt->execute()) {
        header("Location: /admin_dashboard.php?page=profile_desa/profil_desa&subpage=profil_kepala_desa");
        exit();
    } else {
...
<div class="d-flex flex-column">
    <div class="d-flex flex-row justify-content-around my-2">
        ...
        <a href="/admin_dashboard.php?page=profile_desa/profil_desa&subpage=profil_kepala_desa/tambah_data_profil_kepala_desa"
            class="fw-bold text-decoration-none text-success" id="tambah-data-link">Tambah Data</a>
    </div>
    <div class="d-flex flex-row justify-content-end">
        <a href="/admin_dashboard.php?page=profile_desa/profil_desa&subpage=profil_kepala_desa/edit_data_profil_kepala_desa"
...
<script>
    document.getElementById('tambah-data-link').addEventListener('click', function(event) {
        ...
        // Update the URL
        window.history.pushState({}, '', 'admin_dashboard.php?page=profile_desa/profil_desa&subpage=profil_kepala_desa/tambah_data_profil_kepala_desa');
