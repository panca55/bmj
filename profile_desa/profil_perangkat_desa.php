...
<div class="d-flex flex-column">
    <div class="d-flex flex-column text-center">
        ...
        <div class="d-flex flex-row justify-content-end my-2">
            <a href="/admin_dashboard.php?page=profile_desa/profil_desa&subpage=profil_perangkat_desa/tambah_data_perangkat_desa" class="fw-bold text-decoration-none text-success" id="tambah-data-link">Tambah Data</a>
        </div>
            ...
            <tbody>
                <?php foreach ($perangkat_desa as $index => $perangkat): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/admin_dashboard.php?page=profile_desa/profil_desa&subpage=profil_perangkat_desa/edit_data_perangkat_desa&id=<?= $perangkat['id_perangkat_desa']; ?>" class="btn btn-primary btn-sm">Edit</a>
...
<script>
    document.getElementById('tambah-data-link').addEventListener('click', function(event) {
        ...
        // Update the URL
        window.history.pushState({}, '', 'admin_dashboard.php?page=profile_desa/profil_desa&subpage=profil_perangkat_desa/tambah_data_perangkat_desa');
