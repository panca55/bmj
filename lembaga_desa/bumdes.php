...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: /admin_dashboard.php?page=lembaga_desa/lembaga_desa&subpage=bumdes");
        exit();
    } else {
...
<div class="d-flex flex-column">
    <div class="d-flex flex-column text-center">
        ...
        <div class="pb-2 pe-2 ps-2 w-100 text-start mb-2">
            <div class="d-flex flex-row justify-content-end my-2">
                <a href="/admin_dashboard.php?page=lembaga_desa/lembaga_desa&subpage=bumdes/tambah_data_bumdes"
    ...
    <div class="d-flex flex-row justify-content-end">
        <a href="/admin_dashboard.php?page=lembaga_desa/lembaga_desa&subpage=bumdes/edit_data_bumdes"
...
<script>
    document.getElementById('tambah-data-link').addEventListener('click', function(event) {
        ...
        // Update the URL
        window.history.pushState({}, '', 'admin_dashboard.php?page=lembaga_desa/lembaga_desa&subpage=bumdes/tambah_data_bumdes');
