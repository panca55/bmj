...
<div class="d-flex flex-column">
    <div class="d-flex flex-column text-center">
        ...
        <div class="d-flex flex-row justify-content-end my-2">
            <a href="/admin_dashboard.php?page=lembaga_desa/lembaga_desa&subpage=karang_taruna/tambah_data_karang_taruna"
    ...
    <div class="d-flex flex-row justify-content-end">
        <a href="/admin_dashboard.php?page=lembaga_desa/lembaga_desa&subpage=karang_taruna/edit_data_karang_taruna"
...
<script>
    document.getElementById('tambah-data-link').addEventListener('click', function(event) {
        ...
        // Update the URL
        window.history.pushState({}, '', 'admin_dashboard.php?page=lembaga_desa/lembaga_desa&subpage=karang_taruna/tambah_data_karang_taruna');
