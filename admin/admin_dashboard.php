...
<body>
    <div class="sidebar d-flex flex-column" id="sidebar">
        <div>
            <a href="admin_dashboard.php?page=dashboard/dashboard" class="<?= $page == 'dashboard/dashboard' ? 'active' : '' ?>"><i class="bi bi-speedometer2"></i>Dashboard</a>
            <a href="admin_dashboard.php?page=profile_desa/profil_desa" class="<?= $page == 'profile_desa/profil_desa' ? 'active' : '' ?>"><i class="bi bi-house-door"></i>Profil Desa</a>
            <a href="admin_dashboard.php?page=layanan_desa/layanan_desa" class="<?= $page == 'layanan_desa/layanan_desa' ? 'active' : '' ?>"><i class="bi bi-briefcase"></i>Layanan Desa</a>
            <a href="admin_dashboard.php?page=lembaga_desa/lembaga_desa" class="<?= $page == 'lembaga_desa/lembaga_desa' ? 'active' : '' ?>"><i class="bi bi-people"></i>Lembaga Desa</a>
