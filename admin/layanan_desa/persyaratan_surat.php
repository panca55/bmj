...
<div class="d-flex flex-column">
    <div class="d-flex flex-column text-center">
        ...
        <div class="d-flex flex-row justify-content-end my-2">
            <a href="/admin/admin_dashboard.php?page=layanan_desa/layanan_desa&subpage=persyaratan_surat/tambah_data_persyaratan_surat" class="fw-bold text-decoration-none text-success" id="tambah-data-link">Tambah Data</a>
        </div>
            ...
            <tbody>
                <?php foreach ($persyaratan_surat as $index => $persyaratan): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/admin/admin_dashboard.php?page=layanan_desa/layanan_desa&subpage=persyaratan_surat/edit_data_persyaratan_surat&id=<?= $persyaratan['id_persyaratan_surat']; ?>" class="btn btn-primary btn-sm">Edit</a>
...
<script>
    document.getElementById('tambah-data-link').addEventListener('click', function(event) {
        ...
        // Update the URL
        window.history.pushState({}, '', 'admin/admin_dashboard.php?page=layanan_desa/layanan_desa&subpage=persyaratan_surat/tambah_data_persyaratan_surat');
